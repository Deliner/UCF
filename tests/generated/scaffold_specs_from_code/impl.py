...
from .interface import GenerateResult, ScaffoldSpecsFromCodeInterface, ScanResult
...
class ScaffoldSpecsFromCodeImpl(ScaffoldSpecsFromCodeInterface):
    ...
    def action_scan(self, source_dir: Any, patterns: Any = None) -> ScanResult:
        scanner = ASTScanner(self._source_dir)
    ...
    def action_generate(self, functions: Any, classes: Any, output_dir: Any) -> GenerateResult:
        ...
        self._gen = gen.generate(self._scan.functions, self._scan.classes)
...
class ScaffoldEmptyImpl(ScaffoldSpecsFromCodeInterface):
    ...
    def action_generate(self, functions: Any, classes: Any, output_dir: Any) -> GenerateResult:
        return GenerateResult(action_specs=[], component_specs=[], specs_written=0)
